...
public class Consts {
	...
	public static final String ROUTER_THEACHER= "/teacher";
	public static final String ROUTER_MSG = "/msg";
	public static final String ROUTER_PRIZE = "/prize";
    public static final String ROUTER_SIGNUP= "/signup";
